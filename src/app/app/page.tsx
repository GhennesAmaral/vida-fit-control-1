                    ...
                    <div className="flex-1">
                      ...
                      {needsConfig && (
                        <div className="space-y-2 text-sm text-orange-800">
                          <p className="font-medium">Para usar esta funcionalidade, você precisa:</p>
                          <ol className="list-decimal list-inside space-y-1 ml-2">
                            <li>Obter uma chave de API da OpenAI em <a href="https://platform.openai.com/api-keys" target="_blank" rel="noopener noreferrer" className="underline font-medium">platform.openai.com</a></li>
                            <li>Adicionar a variável <code className="px-2 py-0.5 bg-orange-100 rounded font-mono text-xs">OPENAI_API_KEY</code> nas configurações do projeto</li>
                            <li>Recarregar a página e tentar novamente</li>
                          </ol>
                          <div className="mt-4 p-3 bg-orange-100 rounded-lg">
                            <p className="text-xs font-medium">💡 Dica: Procure por um banner laranja no topo da página para configurar rapidamente!</p>
                          </div>
                        </div>
                      )}
                    </div>
